...
namespace IVRCommon.Keyboard
{
    ...
    [CustomEditor(typeof(IVRInputField), true)]
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(m_TextComponent == null || m_TextComponent.objectReferenceValue == null))
            {
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)IVRInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)IVRInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)IVRInputField.ContentType.Custom)
                        EditorGUILayout.PropertyField(m_LineType);

                    if (m_ContentType.enumValueIndex == (int)IVRInputField.ContentType.Custom)
                    {
    ...
    static internal class MenuOptions
    {
        ...
        [MenuItem("GameObject/UI/IVR Input Field", false, 2036)]
        ...
        {
            GameObject root = CreateUIElementRoot("IVRInputField", s_ThickElementSize);
            ...
            IVRInputField inputField = root.AddComponent<IVRInputField>();
