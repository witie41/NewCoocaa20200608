...
#pragma warning disable CS0109 // 成员“GvrController.Orientation”不会隐藏可访问成员。不需要关键字 new。
  public new static Quaternion Orientation {
#pragma warning restore CS0109 // 成员“GvrController.Orientation”不会隐藏可访问成员。不需要关键字 new。
    get {
